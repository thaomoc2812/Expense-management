        ...
        ?>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <a onclick="return confirm('Xóa nhóm quyền này sẽ khiến các người dùng của nhóm bị hạn chế các chức năng tương ứng. Chắc chắn xóa?')" href="deleteNhomQuyen.php?idnhomquyen=<?php echo $r1['id'] ?>"  class="btn btn-danger">Xóa</a>
                  </th>
