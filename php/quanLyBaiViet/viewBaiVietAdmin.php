    ...
    <div class="container">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          $view_sql = "SELECT * FROM baivietadmin ";
          ...
          ?>
            ...
            <tr>
              <td><?php echo $r['baiviet'] ?></td>
             
              <td><a href="editBaiViet.php?sid=<?php echo $r['id'] ?>" class="btn btn-info">Sửa</a>
                <a onclick="return confirm('Bạn có muốn xóa bài viết này không?')" href="deleteBaiVietAdmin.php?sid=<?php echo $r['id'] ?>" class="btn btn-danger">Xóa</a>
              </td>
            </tr>
          <?php
          }
