...
$edit_sql = "SELECT * FROM baivietadmin WHERE id = $nvid";
...
<body class="page-body  page-fade" onload="collapseSidebar()">
  ...
  <div class="page-container sidebar-collapsed" id="navbarcollapse">
    ...
    <div class="container">
            <h1>Sửa bài viết</h1>
            <form action="updateBaiViet.php" method="post">
                <input type="hidden" name="sid" value="<?php echo $row['id'] ?>" id="">
                <div class="form-group">
                    <label for="baiviet">Bài viết</label>
                    <input type="text" id="baiviet" class="form-control" name="baiviet" value="<?php echo $row['baiviet'] ?>">
                </div>
