...
$search_sql1 = "SELECT * FROM baivietuser WHERE id = $nvid";

$result1 = mysqli_query($conn, $search_sql1);
$r1 = mysqli_fetch_assoc($result1);

$iduser = $r1['idnguoidung'];

$search_sql2 = "SELECT * FROM nguoidung WHERE id = '$iduser'";
    ...
    <div class="container">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          $view_sql = "SELECT * FROM baivietuser WHERE id = $nvid";
